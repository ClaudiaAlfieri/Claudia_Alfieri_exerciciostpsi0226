...
for nome in nomes:
    ...
    print(nomes)
    print(len(nomes))
    #len devolve o número de itens na lista
    print(nomes.index('Antonio'))
    #index devolve o indice do elemento da lista, se tiver mais de um elemento igual, ele devolve o indice do primeiro elemento encontrado
